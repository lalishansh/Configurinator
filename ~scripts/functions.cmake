...
MACRO(FIND_VCPKG)
    ...
    get_filename_component(temp_VcpkgManifestFilePath "${VCPKG_MANIFEST_DIR}" REALPATH BASE_DIR "${CMAKE_SOURCE_DIR}")
    FILE(READ "${temp_VcpkgManifestFilePath}/vcpkg.json" VCPKG_MANIFEST_RAW)
...
MACRO(CREATE_PACKAGES_VIA_CPACK archive_only)
    ...
    ELSEIF (${CMAKE_SYSTEM_NAME} MATCHES "Linux")
        ...
        IF (NOT archive_only)
            FIND_PROGRAM(DPKG_PRO`GRAM dpkg DOC "dpkg program of Debian-based systems")
            IF(DPKG_PROGRAM)
